...
import com.corhuila.backendmovilnosql.IService.ITiposProductosService;
...
public class TiposProductosController {
	...
	@GetMapping("{id}")
	public Optional<TiposProductos> show(@PathVariable String id) {
	...
	@PutMapping("{id}")
	@ResponseStatus(code = HttpStatus.CREATED)
	 public TiposProductos update(@PathVariable String id, @RequestBody TiposProductos tiposProductos) {
